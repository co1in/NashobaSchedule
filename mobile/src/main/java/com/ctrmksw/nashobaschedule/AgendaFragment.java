...
public class AgendaFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        ScrollView scrollRoot = (ScrollView) inflater.inflate(R.layout.agenda_view, container, false);
        LinearLayout root = (LinearLayout) scrollRoot.findViewById(R.id.agenda_root_layout);
    ...
    private void populateMainCard(LinearLayout root)
    {
    ...
    private void populateScheduleCard(LinearLayout root)
    {
